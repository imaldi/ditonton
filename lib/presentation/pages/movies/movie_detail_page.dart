    ...
    return Scaffold(
      body: BlocBuilder<MovieDetailCubit, MovieDetailState>(
        builder: (context, state) {
          ...
          return switch (movieState) {
            RequestState.Empty => Container(),
            RequestState.Loading => Center(child: CircularProgressIndicator()),
            RequestState.Loaded when movie != null => SafeArea(
              child: DetailContent(movie, movieRecommendations, isAddedToWatchlist),
            ),
                            ...
                            BlocConsumer<MovieDetailCubit, MovieDetailState>(
                              ...
                              builder: (context, state) {
                                return ElevatedButton(
                                  onPressed: () async {
                                    if (!isAddedWatchlist) {
                                      context.read<MovieDetailCubit>().addWatchlist(movie);
                                    } else {
                                      context.read<MovieDetailCubit>().removeFromWatchlist(movie);
                                    }
                                  },
                                  child: Row(
